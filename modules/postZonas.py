...
def postZonas():
    ...
    while True: 
        ...
        posicion = requests.post("http://154.38.171.54:5501/zonas", data=json.dumps(zonas, indent=4))
        res =posicion.json()
        tablazona = [zonas]
...
def updatezonas(id):
    ...
    while True:
        ...
        peticion = requests.put(f'http://154.38.171.54:5501/zonas/{id}', data=json.dumps(zonaactualizada, indent=4))
        res = peticion.json()
